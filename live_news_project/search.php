...
$search_query = " SELECT * FROM post WHERE post.post_title = '{$search}'";
$search_result = mysqli_query($connection,$search_query) or die("Search query failed");
$search_fetch = mysqli_fetch_assoc($search_result);
?>
...
<?php 
    ...
    include "admin/config.php";
        ...
        $query5 = "SELECT * FROM post WHERE post.post_title LIKE '%{$search}%'";
    ...
    if(mysqli_num_rows($result5)){
      ...
      if ($page > 1) {
        echo '<li><a href="search.php?cid='.$search.'&page='.($page - 1).'">Prev</a></li>';
      }
